...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 50, kernel_size=3, stride= 1, padding=2),  # RGB image channel = 3, output channel = num_filter
            nn.BatchNorm2d(50),
            nn.ReLU())
        self.layer2 = nn.Sequential(
            ...
            nn.BatchNorm2d(50),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size = 2, stride = 2)) #output size (50,61,61)

        self.layer3 = nn.Sequential(
            nn.Conv2d(50, 50, kernel_size=3, stride=1, padding=2),
            nn.BatchNorm2d(50),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size = 2, stride = 2)) #output size(50,32,32)

        self.fc1 = nn.Linear(50*32*32, 64)
